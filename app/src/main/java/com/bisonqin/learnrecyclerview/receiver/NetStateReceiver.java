package com.bisonqin.learnrecyclerview.receiver;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.bisonqin.learnrecyclerview.receiver.CONNECTIVITY_CHANGE";
